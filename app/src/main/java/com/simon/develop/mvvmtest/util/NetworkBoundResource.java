...
public abstract class NetworkBoundResource<CacheObject, RequestObject> {
    ...
    private void init() {
        // update LiveData fpr loading status
        ...
        results.addSource(apiResponse, new Observer<ApiResponse<RequestObject>>() {
            ...
            public void onChanged(ApiResponse<RequestObject> requestObjectApiResponse) {
                ...
                if (requestObjectApiResponse instanceof ApiResponse.ApiSuccessResponse) {
                    ...
                    Log.d(TAG, "onChanged: ApiEmptyReponse");
                    appExecutors.mainThread().execute(new Runnable() {
                        @Override
                        public void run() {
                            results.addSource(loadFromDb(), new Observer<CacheObject>() {
                    ...
                    results.addSource(dbSource, new Observer<CacheObject>() {
                        @Override
                        public void onChanged(CacheObject cacheObject) {
                            Log.d(TAG, "onChanged: ApiErrorResponse " + ((ApiResponse.ApiErrorResponse) requestObjectApiResponse).getErrorMessage());
                            setValue(
                                    Resource.error(
