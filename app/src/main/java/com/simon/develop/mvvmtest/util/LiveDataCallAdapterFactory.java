package com.simon.develop.mvvmtest.util;
...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
    ...
    /**
     * This method performs a number of checks and then returns the Response
     * type for the Retrofit requests.
     * (@bodyType is the ResponseType. It can be EarthquakeResponse or EarthquakeSearchResponse)
     *
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        // FYI: T is will be a EarthquakeSearchResponse or another future response
